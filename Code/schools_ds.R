...
kent_school_2018 = read_csv("Obtained/School/Kent 2018-2019 School Dataset.csv")
surrey_school_2018 = read_csv("Obtained/School/Surrey 2018-2019 School Dataset.csv")
kent_school_2021 = read_csv("Obtained/School/Kent 2021-2022 School Dataset.csv")
surrey_school_2021 = read_csv("Obtained/School/Surrey 2021-2022 School Dataset.csv")
...
write_csv(cleaned_school,"Cleaned/school_cleaned.csv")
