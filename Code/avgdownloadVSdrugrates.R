...
population_dataset = read_csv('Cleaned/cleaned_population.csv')
cleaned_crime_dataset= read_csv('Cleaned/cleaned_crime.csv')
cleaned_broadband_speed= read_csv('Cleaned/broadband_cleaned.csv') 
